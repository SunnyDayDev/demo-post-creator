...
public final class PermissionRequestInteractorImpl implements dev.sunnyday.postcreator.core.permissions.PermissionRequestInteractor {
    ...
    private final io.reactivex.Completable requestPermission(androidx.fragment.app.FragmentActivity activity, dev.sunnyday.postcreator.core.permissions.PermissionRequest request) {
        return null;
    }
